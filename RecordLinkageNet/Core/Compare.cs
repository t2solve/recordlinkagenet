...
namespace RecordLinkageNet.Core
{
    ...
    {  
        ...
        private List<CompareCondition> myConditionList = new List<CompareCondition>();//condition list 
        ...
        public void Exact(string dataAColName, string dataBColName, string newColLabel =null)
        {
            ...
            //we save the have 
            CompareCondition j = new CompareCondition();
            j.Mode = CompareCondition.CompareType.Exact;
            j.NameColA = dataAColName;
            j.NameColB = dataBColName;
            j.NameColNewLabel = newColLabel;

            j.SetNewColName();
            myConditionList.Add(j);
        }

        public void String(string dataAColName, string dataBColName, CompareCondition.StringMethod method, float threshold = -1.0f, string newColLabel = null)
        {
            ...
            //we save the have 
            CompareCondition j = new CompareCondition();
            j.Mode = CompareCondition.CompareType.String;
            j.NameColA = dataAColName;
            j.NameColB = dataBColName;
        ...
        public float GetRamUsedInMegaByte()
        {
            ...
            using (Process proc = Process.GetCurrentProcess())
            {
                ...
                memory = (float)(proc.PrivateMemorySize64 / (1024 * 1024));
            }
            return memory;
        }
